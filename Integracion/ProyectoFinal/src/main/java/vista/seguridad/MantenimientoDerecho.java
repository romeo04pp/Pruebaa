...
public class MantenimientoDerecho extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Mantenimiento Derechos Aplicaciones en Perfiles");
        setVisible(true);
